...
vi.describe("〖⛳️〗‹‹‹ ❲@traversable/core/ast❳", () => {
  ...
  vi.it("〖⛳️〗› ❲ast: `ast.toJsonSchema` adapter❳", () => {
    ...
    ).toMatchInlineSnapshot(`"{"type":"object","required":[],"properties":{"a":{"type":"object","required":[],"properties":{"b":{"type":"array","items":[{"type":"object","required":[],"properties":{"d":{"type":"number"},"e":{"type":"array","items":[{"type":"array","items":[{"type":"array","items":[{"type":"object","required":["f","g"],"properties":{"f":{"type":"string"},"g":{"type":"boolean"}}}],"minItems":1,"maxItems":1,"additionalItems":false}],"minItems":1,"maxItems":1,"additionalItems":false}],"minItems":1,"maxItems":1,"additionalItems":false},"c":{"type":"boolean"},"f":{"type":"number"}}},{"type":"object","required":["g"],"properties":{"g":{"type":"number"}}}],"minItems":2,"maxItems":2,"additionalItems":false},"h":{"type":"number"}}}}}"`)
    ...
    vi.expect($(seed.tuple_00.toJsonSchema)).toMatchInlineSnapshot(`"{"type":"array","items":[],"minItems":0,"maxItems":0,"additionalItems":false}"`)
    vi.expect($(seed.tuple_01.toJsonSchema)).toMatchInlineSnapshot(`"{"type":"array","items":[{"type":"null","enum":[null]}],"minItems":1,"maxItems":1,"additionalItems":false}"`)
    vi.expect($(seed.tuple_02.toJsonSchema)).toMatchInlineSnapshot(`"{"type":"array","items":[{"type":"boolean"}],"minItems":1,"maxItems":1,"additionalItems":false}"`)
    vi.expect($(seed.tuple_03.toJsonSchema)).toMatchInlineSnapshot(`"{"type":"array","items":[{"type":"integer"}],"minItems":1,"maxItems":1,"additionalItems":false}"`)
    vi.expect($(seed.tuple_04.toJsonSchema)).toMatchInlineSnapshot(`"{"type":"array","items":[{"type":"number"}],"minItems":1,"maxItems":1,"additionalItems":false}"`)
    vi.expect($(seed.tuple_05.toJsonSchema)).toMatchInlineSnapshot(`"{"type":"array","items":[{"type":"string"}],"minItems":1,"maxItems":1,"additionalItems":false}"`)
    vi.expect($(seed.tuple_06.toJsonSchema)).toMatchInlineSnapshot(`"{"type":"array","items":[{"type":"null","enum":[null]},{"type":"null","enum":[null]}],"minItems":2,"maxItems":2,"additionalItems":false}"`)
    vi.expect($(seed.tuple_07.toJsonSchema)).toMatchInlineSnapshot(`"{"type":"array","items":[{"type":"boolean"},{"type":"boolean"}],"minItems":2,"maxItems":2,"additionalItems":false}"`)
    vi.expect($(seed.tuple_08.toJsonSchema)).toMatchInlineSnapshot(`"{"type":"array","items":[{"type":"integer"},{"type":"integer"}],"minItems":2,"maxItems":2,"additionalItems":false}"`)
    vi.expect($(seed.tuple_09.toJsonSchema)).toMatchInlineSnapshot(`"{"type":"array","items":[{"type":"number"},{"type":"number"}],"minItems":2,"maxItems":2,"additionalItems":false}"`)
    vi.expect($(seed.tuple_10.toJsonSchema)).toMatchInlineSnapshot(`"{"type":"array","items":[{"type":"string"},{"type":"string"}],"minItems":2,"maxItems":2,"additionalItems":false}"`)
    vi.expect($(seed.tuple_11.toJsonSchema)).toMatchInlineSnapshot(`"{"type":"array","items":[{"type":"string"},{"type":"string"}],"minItems":2,"maxItems":2,"additionalItems":false}"`)
...
//   const ex_01 = short({ a: "boolean", b: "number[]", c: "string{}" })
...
// vi.describe("〖🧙〗‹‹‹ ❲@traversable/core/ast❳", () => {
  ...
  // vi.it("〖🧙〗› ❲ast.typeof❳", () => {
  //   vi.assertType<null>(t.typeof(short(null)))
  //   vi.assertType<"abc">(t.typeof(short("'abc'")))
  //   vi.assertType<boolean>(t.typeof(short("boolean")))
  //   vi.assertType<symbol>(t.typeof(short("symbol")))
  //   vi.assertType<integer>(t.typeof(short("integer")))
  //   vi.assertType<number>(t.typeof(short("number")))
  //   vi.assertType<string>(t.typeof(short("string")))
  //   vi.assertType<boolean[]>(t.typeof(short("boolean[]")))
  //   vi.assertType<symbol[]>(t.typeof(short("symbol[]")))
  //   vi.assertType<integer[]>(t.typeof(short("integer[]")))
  //   vi.assertType<number[]>(t.typeof(short("number[]")))
  //   vi.assertType<string[]>(t.typeof(short("string[]")))
  //   vi.assertType<Record<string, boolean>>(t.typeof(short("boolean{}")))
  //   vi.assertType<Record<string, symbol>>(t.typeof(short("symbol{}")))
  //   vi.assertType<Record<string, integer>>(t.typeof(short("integer{}")))
  //   vi.assertType<Record<string, number>>(t.typeof(short("number{}")))
  //   vi.assertType<Record<string, string>>(t.typeof(short("string{}")))
  //   vi.assertType<[boolean, string, number]>(t.typeof(short(["boolean", "string", "number"])))
  //   vi.assertType
  //     <{ a: boolean[], b: { c: [Record<string, string>] } }>
  //     (t.typeof(short( { a: "boolean[]", b: { c: ["string{}"] } })))
  //   vi.assertType
  //     <{ a: boolean } & { b: string[] }>
  //     (t.typeof(short( "&", { a: "boolean" }, { b: "string[]" } )))
  //   vi.assertType
  //     <{ a: string } | { b: null }>
  //     (t.typeof(short( "|", { a: "string" }, { b: null } )))
  //   vi.assertType
  //     <{ a: { b: string[] } }[]>
  //     (t.typeof(short("[]", { a: { b: "string[]" } })))
  //   vi.assertType
  //     <{ a: number, b?: boolean, c?: { d?: number[] } }>
  //     (t.typeof(short( { a: "number", "b?": "boolean", "c?": { "d?": "number[]" } })))
  //   vi.assertType
  //     <
  //       {
  //         a: string[]
