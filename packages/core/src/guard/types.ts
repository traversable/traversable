...
// export type Target<S> = S extends Guard<infer T> ? T : never

// export type Intersect<T> = never | Intersect.loop<{ [x in keyof T]: Target<T[x]> }, unknown>
// export declare namespace Intersect {
//   type loop<S, O> = S extends readonly [infer H, ...infer T] ? loop<T, O & H> : O
// }
