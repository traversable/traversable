...
export namespace format {
  ...
  // export const isKnownIntegerFormat = schema.is.literally(...KnownIntegerFormats)
  ...
  // export const isExtendedIntegerFormat = schema.is.literally(...ExtendedIntegerFormats)
  ...
  // export const isIntegerFromat = schema.is.literally(...IntegerFormats)
  ...
  // export const isKnownNumberFormat = schema.is.literally(...KnownNumberFormats)

  export type number_ = (typeof NumberFormats[number])[number]
  // export const ExtendedNumberFormats = schema.is.literally(...KnownNumberFormats)
  ...
  // export const isNumberFormat = schema.is.literally(...KnownNumberFormats)
  ...
  // export const isKnownStringFormat = schema.is.literally(...KnownStringFormats)
  ...
  // export const isExtendedStringFormat = schema.is.literally(...ExtendedStringFormats)
  ...
  // export const isStringFormat = schema.is.literally(...StringFormats)
...
export const Schema_is
  ...
  = schema.anyOf$(
    tree.has("type", schema.is.literally(...DataTypes)),
    tree.has("$ref", schema.is.string),
    tree.has('const', schema.is.any),
    Schema_isAllOf,
    Schema_isAnyOf,
    Schema_isOneOf,
  ) as never
...
export function Schema_isOneOf(u: unknown): u is Schema_oneOf<Schema> {
  return tree.has("oneOf", schema.array$(Schema_is))(u)
}
...
export function Schema_isAnyOf(u: unknown): u is Schema_anyOf<Schema> {
  return tree.has("anyOf", schema.array$(Schema_is))(u)
}
...
export function Schema_isAllOf(u: unknown): u is Schema_allOf<Schema> {
  return tree.has("allOf", schema.array$(Schema_is))(u)
}

export const Schema_isNull
  : (u: unknown) => u is Schema_null
  = schema.allOf$(
    tree.has("type", schema.is.literally(DataType.null)),
    // tree.has("enum", 0, schema.is.literally(null)),
    // tree.has("nullable", schema.is.literally(true)),
  ) as never
...
export const Schema_isBoolean
  ...
  = tree.has("type", schema.is.literally(DataType.boolean))

export const Schema_isInteger 
  : (u: unknown) => u is Schema_integer
  = tree.has("type", schema.is.literally(DataType.integer))

export const Schema_isNumber
  : (u: unknown) => u is Schema_number
  = tree.has("type", schema.is.literally(DataType.number))

export const Schema_isString
  : (u: unknown) => u is Schema_string
  = tree.has("type", schema.is.literally(DataType.string))

export const Schema_isObject
  = (u: unknown): u is Schema_object => schema.allOf$(
    tree.has("type", schema.is.literally(DataType.object)),
    tree.has("properties", (u): u is typeof u => {
      if (u === null || typeof u !== "object") return false
      else if (schema.is.array(u)) return false
      else return !("additionalProperties" in u) && schema.record$(Schema_is)(u)
    }),
  )(u)
...
export const Schema_isArray: {
  ...
  tree.has("type", schema.is.literally(DataType.array)),
  tree.has("items", (u): u is typeof u => !Array_isArray(u) /* Schema_is */)
)

export const Schema_isTuple: {
  (u: unknown): u is Schema_tuple
} = (u: unknown): u is Schema_tuple => schema.allOf$(
  tree.has("type", schema.is.literally(DataType.array)),
  tree.has("items", schema.is.array),
)(u)
