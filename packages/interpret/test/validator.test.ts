...
import { validator, type Ext, JsonSchema } from "@traversable/interpret"
...
vi.describe("〖️⛳️〗‹‹‹ ❲@traversable/interpret/validator❳", () => {
  ...
  type _9 = typeof ex_01 extends Ext ? true : false

  vi.it("〖️⛳️〗› ❲equal.deriveEq❳", () => {
    console.log(validator.derive(ex_01))
